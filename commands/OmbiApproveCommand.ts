...
export class OmbiApproveCommand implements ISlashCommand {
  public command = 'ombi-approve';
  public i18nParamsExample = 'slashcommand_approve_params';
  public i18nDescription = 'slashcommand_approve_description';
  ...
  public async executor(context: SlashCommandContext, read: IRead, modify: IModify, http: IHttp, persis: IPersistence): Promise<void> {
    ...
    if (requestResponse.statusCode === 200 && requestResponse.content && requestResponse.content) {
      ...
      let message = (jsonResult && jsonResult.message) ? jsonResult.message : (typeForReturnMessage + ' ' + id + ' has been successfully approved!');
      let color = '#00CE00';
